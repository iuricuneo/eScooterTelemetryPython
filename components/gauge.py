...
class Gauge(Widget):
    ...
    file_gauge = StringProperty(join(path, "../img/cadran.png"))
    file_needle = StringProperty(join(path, "../img/needle.png"))
    size_gauge = BoundedNumericProperty(300, min=128, max=512, errorvalue=128)
